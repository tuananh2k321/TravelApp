...
const DetailCancelBooking = ({ navigation, route }) => {
    ...
    return (
        <>
            <ScrollView>
                <SafeAreaView style={{ backgroundColor: "white", height: SIZES.height }}>
                    <View style={styles.header}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10, marginTop: 10 }}>
                            ...
                            <Text style={{ fontSize: 22, fontWeight: 'bold', color: 'black', color: '#0FA3E2' }}>Chi Tiết</Text>
                    ...
                    <View style={{ marginHorizontal: 15 }}>
                        ...
                        {bookings.confirm ? (
                            ...
                            <View>
                                <Text style={{ color: "black", fontWeight: "bold", marginVertical: 15, fontSize: 18 }}>
                                    Chưa xác nhận
                                </Text>
