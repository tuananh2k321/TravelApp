...
import { isValidEmpty, validateDateOfBirth, validateDateOfBirthAdult } from '../../constant/Validation';
  ...
  return (
    <View style={styles.container}>
      ...
      <DatePicker
        ...
        mode="date"
        minimumDate={new Date('1963-12-31')}
        maximumDate={new Date('2008-12-31')}
        date={currentDate}
        onConfirm={date => {
            setOpen(false);
            ...
            setErrorBirthday(
              validateDateOfBirthAdult(day + '/' + month + '/' + year),
            );
